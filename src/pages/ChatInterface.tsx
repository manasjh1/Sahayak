  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 1,
      type: 'assistant',
      content: 'Hello! I\'m Sahayak, your education assistant. How can I help you today?',
      timestamp: new Date()
    }
  ]);
      ...
      <div className="bg-white/80 backdrop-blur-sm border-b border-border/50 sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-foreground">Sahayak Chat</h1>
              <p className="text-sm text-muted-foreground">Your AI Education Assistant</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <main className="flex-1 px-4 py-6">
          <div className="max-w-5xl mx-auto">
            <Card className="h-full">
              <CardHeader>
                <CardTitle className="text-foreground">Ask Any Question</CardTitle>
              </CardHeader>
                ...
                <div className="space-y-3">
                  <div className="flex space-x-2">
                    <textarea
                      ...
                      placeholder="Input your question in your local language..."

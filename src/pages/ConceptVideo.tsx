    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden">
                ...
                {showVideo && animationPhase === 3 && (
                    <div className="mb-12 transform transition-all duration-1000 animate-fadeIn">
                        <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/20 backdrop-blur-sm">
                            <video
                                className="w-full max-w-2xl h-[400px] object-cover rounded-2xl"
                                controls
                                autoPlay
                            >
                    ...
                    {concepts.map((concept, index) => (
                        <div
                            ...
                            style={{
                                ...
                                animation: `slideUp 0.8s ease-out ${concept.delay} both, floatInOut 8s ease-in-out ${parseFloat(concept.delay) + 2}s infinite`
                            }}
            ...
            <style>{`
                ...
                .animate-float-in-out {
                    animation: floatVideoInOut 10s ease-in-out 1s infinite;
                }
            `}</style>
        </div>
    );
